...
// 1. Add HeroModal import, remove createPortal import
content = content.replace("import { createPortal } from 'react-dom';\n", "");
content = content.replace("import { HeroTable } from './common/ui/HeroTable';", "import { HeroModal } from './common/ui/HeroModal';\nimport { HeroTable } from './common/ui/HeroTable';");

// 2. Modal 1 Replacement
...
// 3. Modal 2 Replacement (Alert Dialog)
const m2Old = `  {/* CUSTOM HEROUI ALERT DIALOG: Confirmation before delete to avoid blocking browser popups */}
...
const m2New = `  {/* CUSTOM HEROUI ALERT DIALOG: Confirmation before delete to avoid blocking browser popups */}
  <HeroModal
...
// 4. Modal 3 Replacement (Enlist Employee)
const m3Old = `   {/* MODAL: DIRECT ENLIST EMPLOYEE */}
...
const m3New = `   {/* MODAL: DIRECT ENLIST EMPLOYEE */}
...
console.log('Replaced BranchModule modals cleanly!');
