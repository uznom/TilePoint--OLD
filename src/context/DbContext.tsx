...
const SEED_BRANDS: Brand[] = [
  {
    ...
    name: "Mariwasa",
    supplierId: "S1",
    description: "Premium decorative ceramic & porcelain floor tiles",
    isDeleted: false,
    createdAt: new Date("2026-01-01T08:00:00Z").toISOString(),
  },
  {
    ...
    name: "Lepanto",
    supplierId: "S1",
    description: "Vibrant and heavy-duty tiles",
    isDeleted: false,
    createdAt: new Date("2026-01-01T08:00:00Z").toISOString(),
  },
  {
    ...
    name: "Pioneer",
    supplierId: "S1",
    description: "Standard high-grade ceramics",
    isDeleted: false,
    createdAt: new Date("2026-01-01T08:00:00Z").toISOString(),
  },
  {
    ...
    name: "Kito",
    supplierId: "S2",
    description: "Architectural tiles and slab design collections",
    isDeleted: false,
  ...
  },
  {
    ...
    supplierId: "S2",
    description: "Glossy white polished and modern matte finishes",
    isDeleted: false,
    createdAt: new Date("2026-01-05T08:00:00Z").toISOString(),
  },
  {
    id: "BND-6",
    name: "TilePoint Premium",
    supplierId: "S3",
    description: "In-house luxury marble-effect porcelain slabs",
    isDeleted: false,
    createdAt: new Date("2026-01-10T08:00:00Z").toISOString(),
  },
  {
    id: "BND-7",
    name: "TilePoint Standard",
    supplierId: "S3",
    description: "Affordable commercial porcelain tiles",
    isDeleted: false,
    createdAt: new Date("2026-01-10T08:00:00Z").toISOString(),
  },
  {
    ...
    name: "ClayWorks",
    supplierId: "S4",
    description: "Handcrafted terracotta and clay tiles",
    isDeleted: false,
    createdAt: new Date("2026-01-15T08:00:00Z").toISOString(),
  },
];
...
const generateSeedSales = (
  ...
  const customers = [
    "Enrique Concepcion",
    "Samantha Roxas",
    "Davao Tile Contractors",
    "Arch. Gabriel Lizares",
    "Talisay Housing Corp",
    "Rupert Villa",
    "Regina Alunan",
    "MegaWorld Bacolod Project",
    "Estancia Builders",
    "Maria Luz Araneta",
    "Silay Heritage Restoration",
    "Vicente Lopez",
  ];
    ...
    branches.forEach((b) => {
      ...
      while (accumulated < branchTarget) {
        ...
        for (let k = 0; k < numItems; k++) {
          ...
          const maxQty = isBulk
            ? Math.floor(saleValue / p.sellingPrice)
            : Math.floor((saleValue * 0.6) / p.sellingPrice);
        ...
        const customer = isBulk
          ? Math.random() < 0.5
            ? "Bacolod Heights Premium Homes"
            : "Metro Visayas Construction"
        ...
        const sale: Sale = {
          ...
          isDeleted: false,
          notes: isBulk
            ? "Bulk contract Builder rates applied"
            : "Walk-in retail client",
        };
