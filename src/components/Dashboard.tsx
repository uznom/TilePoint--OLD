 ...
 *****************************************************************************/
 ...
 branches.filter(b => !b.isDeleted).forEach((br, index) => {
  const days = br.operatingDays || ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"];
 ...
 >
 {lowStockProducts.length > 0 && <span className="absolute top-1 right-2 h-2 w-2 rounded-full bg-amber-500" />}
 ...
 >
 {criticalStockProducts.length > 0 && <span className="absolute top-1 right-2 h-2 w-2 rounded-full bg-rose-500" />}
 ...
 >
 {outOfStockProducts.length > 0 && <span className="absolute top-1 right-2 h-2 w-2 rounded-full bg-red-500" />}
