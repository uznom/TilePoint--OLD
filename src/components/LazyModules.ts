...
const MODULE_LOADERS: Record<string, ModuleLoader> = {
  ...
  'adjustments-void': () => import('./AtposExtraModules') as Promise<ComponentModule>,
  ...
  'suppliers-manage': () => import('./AtposExtraModules') as Promise<ComponentModule>,
  ...
  'bir-xz': () => import('./SalesTransmissionModule').then((m) => ({ default: m.SalesTransmissionModule })),
  'bir-summary': () => import('./SalesTransmissionModule').then((m) => ({ default: m.SalesTransmissionModule })),
};
